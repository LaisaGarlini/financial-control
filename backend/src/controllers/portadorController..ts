...
class PortadorController {
    async listar(req: Request, res: Response): Promise<void> {
        try {
            const portadores = await PortadorRepository.GetPortadores()
    ...
    async buscarPorId(req: Request, res: Response): Promise<void> {
        try {
            const { id } = req.params
            const portadores = await PortadorRepository.GetPortadorById(+id)
            if (!portadores) {
    ...
    async atualizar(req: Request, res: Response): Promise<void> {
        try {
            ...
            const portador = await PortadorRepository.Update({ id: +id, nome, usuario_id, ativo })
            if (!portador) {
    ...
    async deletar(req: Request, res: Response): Promise<void> {
        try {
            const { id } = req.params
            const portador = await PortadorRepository.Delete(+id)
            if (!portador) {
