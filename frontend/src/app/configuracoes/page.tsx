    ...
    <div className="flex h-screen overflow-hidden">
      ...
      <div className="flex-1 px-8 py-6 overflow-hidden m-0">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 mb-6 mt-0">
          <ConfigBotao href="/banco" icon={faBank} title="Banco" className="w-52 sm:w-auto" />

          <ConfigBotao href="/agencia" icon={faBuilding} title="Agência" />

          <ConfigBotao href="/conta_financeira" icon={faWallet} title="Conta Financeira" />

          <ConfigBotao href="/portador" icon={faUser} title="Portador" />

          <ConfigBotao href="/cartao" icon={faCreditCard} title="Cartão" />

          <ConfigBotao href="/portador_cartao" icon={faIdCard} title="Portador e Cartão" />
        </div>
      </div>
    </div>
  )
