...
import { faBank, faBuilding, faWallet, faUser, faCreditCard, faIdCard, faUsers } from '@fortawesome/free-solid-svg-icons'
        ...
        <div className="flex h-screen overflow-hidden">
            ...
            <div className="flex-1 px-8 py-6 overflow-hidden m-0">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 mb-6 mt-0">
                    ...
                    <ConfigBotao href="/categoria" icon={faIdCard} title="Categoria" iconColor="green" />

                    <ConfigBotao href="/subcategoria" icon={faIdCard} title="Subcategoria" iconColor="blue" />

                    <ConfigBotao href="/pessoa" icon={faUsers} title="Pessoas" iconColor="red" />
                </div>
            </div>
        </div>
    )
